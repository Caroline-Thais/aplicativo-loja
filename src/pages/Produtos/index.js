  ...
  function Produtos( {navigation} ) {
      return (
          <ScrollView style={styles.container}>
             ...
             <Text>Produtos</Text>
            <Image
            style = {{width: 100, height: 150, resizeMode: 'contain', flexDirection: 'row'}}
            source={{
                uri: 'https://i.pinimg.com/736x/c6/b7/d4/c6b7d4f0fa29724668245fbb062e084c.jpg'
                
            }}
            />
            <Text>Vestido Ana-R$87</Text>
